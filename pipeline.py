...
LUA_SHA1 = get_hash(os.path.join(CWD, 'garnek.lua'))
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/a/a1/Garnek-app-icon.png" height="50px" title=""/>
        <h2>Garnek.pl <span class="links"><a href="https://www.garnek.pl/">Website</a> &middot; <a href="http://tracker.archiveteam.org/garnek/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/garnek">Wiki</a></span></h2>
        <p>Archiving Garnek.pl.</p>
    '''
)
